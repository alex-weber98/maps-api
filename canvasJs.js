var divName = "week-info"


function UpdateChartWithPics (data){
    ...
    var chart = new CanvasJS.Chart(divName, {            
        ...
        data: [{
            ...
            /*
            dataPoints: [
                { label: "Monday", y: [15, 25], name: "rainy" },
    ...
    function addImages(chart) {
        ...
        images[i].attr("class", dpsName).appendTo($(`${divName}>.canvasjs-chart-container`));
    ...
    function positionImage(image, index) {
        ...
        var imageTop =  chart.axisY[0].convertValueToPixel(chart.axisY[0].minimum) +50;
    
        image.width("60px")
        .css({ "left": imageCenter - 30 + "px",
    ...
    $( window ).resize(function() {
        ...
        var imageCenter = 0;
        for(var i=0;i<chart.data[0].dataPoints.length;i++) {
            imageCenter = chart.axisX[0].convertValueToPixel(chart.data[0].dataPoints[i].x) - 30;
